...
/// Data object representing a map index entry. URI is the location of the map repo, name and
/// version are read from the 'map.yml' file located in the map repo.
...
public class MapIndex {
  ...
  /// Description data parsed from description.html. If description file is missing or too long,
  /// then this field will continue an error message with details on how to fix the missing
  /// description.
